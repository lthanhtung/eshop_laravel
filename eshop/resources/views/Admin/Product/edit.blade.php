        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Cập nhập sản phẩm</h5>
                ...
                <div class="card-body">
                    <form action="{{route('admin.product.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                 <span style="width: fit-content" class="input-group-text" id="basic-default-email2">
                                    <img id="preview-image" width="100" src="{{asset('uploads/product/'.$product->image)}}">
                                </span>
